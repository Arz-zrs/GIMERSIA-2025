...
func _on_stage_1_pressed() -> void:
	get_tree().change_scene_to_file("res://Scenes/Stages/tutorial_1.tscn")

func _on_stage_2_pressed() -> void:
	get_tree().change_scene_to_file("res://Scenes/Stages/tutorial_2.tscn")


func _on_stage_3_pressed() -> void:
	get_tree().change_scene_to_file("res://Scenes/Stages/tutorial_3.tscn")
